  ...
  return (
    <button
      ...
      className={cn(
        ...
        compact
          ? "h-full min-h-0 items-center justify-center gap-1.5 border-2 border-gold/50 bg-wood/70 p-2 text-center shadow-[0_4px_0_#3a1c10]"
  ...
  return (
    <div
      className={cn(
        "grid",
        compact
          ? "menu-board h-full min-h-0 flex-1 grid-cols-3 content-stretch gap-2 p-1"
