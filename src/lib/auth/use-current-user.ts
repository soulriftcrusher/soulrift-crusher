...
import { REVIEWER_EMAIL, REVIEWER_NAME } from "./reviewer";
...
export function useCurrentUserState(): CurrentUserState {
  ...
  if (!authEnabled) return { user: demoHunt ? DEMO_USER : DEV_USER, isPending: false };
  ...
  if (demoHunt) return { user: DEMO_USER, isPending: false };
